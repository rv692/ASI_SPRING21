...
dmso1_ly_path_up <- read.delim("./dmso1_ly_reactome_pathway_up_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso1_ly_path_down <- read.delim("./dmso1_ly_reactome_pathway_down_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso4_ly_path_up <- read.delim("./dmso4_ly_reactome_pathway_up_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso4_ly_path_down <- read.delim("./dmso4_ly_reactome_pathway_down_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso1_mirin_path_up <- read.delim("./dmso1_mirin_reactome_pathway_up_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso1_mirin_path_down <- read.delim("./dmso1_mirin_reactome_pathway_down_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso4_mirin_path_up <- read.delim("./dmso4_mirin_reactome_pathway_up_regulated_data.txt",
                             sep = ",", header = TRUE)
dmso4_mirin_path_down <- read.delim("./dmso4_mirin_reactome_pathway_down_regulated_data.txt",
                             sep = ",", header = TRUE)
...
dmso1_ly_path_down$stage <- "MSO1_LY"
...
final_path_prelim <- do.call("rbind", list(dmso1_ly_path_up, dmso1_ly_path_down, dmso4_ly_path_up, dmso4_ly_path_down, dmso1_mirin_path_up, dmso1_mirin_path_down, dmso4_mirin_path_up, dmso4_mirin_path_down))
...
reactome_id <- read.delim("./ReactomePathwaysRelation.txt", header = FALSE)
